...
--Дополнительно отображаем только тех, кому услуга еще не оказана
WITH all_json_key_value AS (
    SELECT queue_id,
           ui.name,
           ui.surname,
...
--Дополнительно отображаем кто ждал приема на оказания услуги больше 10 минут от записанного
WITH all_json_key_value AS (
    SELECT queue_id,
           ui.name,
           ui.surname,
